...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec  5 15:53:56 2019

@author: owner
"""

from tkinter import *
from tkinter import messagebox ; reduce
...
class Employee(Person):
    def __init__(self, employeeNumber, name, gender, nationality, date, addr, department, salary):
...
def add_employee():
    ...
    salary_value = IntVar()
    input1 = Entry(c, textvariable=employee_number_value).place(x=150, y=20)
    input2 = Entry(c, textvariable=name_value).place(x=150, y=40)
    input3 = Entry(c, textvariable=gender_value).place(x=150, y=60)
    input4 = Entry(c, textvariable=nationality_value).place(x=150, y=80)
    input5 = Entry(c, textvariable=dob_value).place(x=150, y=100)
    input6 = Entry(c, textvariable=address_value).place(x=150, y=120)
    input7 = Entry(c, textvariable=department_value).place(x=150, y=140)
    input8 = Entry(c, textvariable=salary_value).place(x=150, y=160)
